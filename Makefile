...
abs_srcdir=	/Users/whosemario/MyApplications/stackless-277-export
abs_builddir=	/Users/whosemario/MyApplications/stackless-277-export
...
BASECFLAGS=	 -fno-strict-aliasing -DSTACKLESS_FRHACK=0
CFLAGS=		$(BASECFLAGS) -g -O2 $(OPT) $(EXTRA_CFLAGS)
# Both CPPFLAGS and LDFLAGS need to contain the shell's value for setup.py to
# be able to build extension modules using the directories specified in the
# environment variables
CPPFLAGS=	-I. -IInclude -I$(srcdir)/Include -I$(srcdir)/Stackless 
LDFLAGS=	
LDLAST=		
SGI_ABI=	
CCSHARED=	
...
prefix=		/Users/whosemario/MyApplications/stackless-bin
...
CONFIG_ARGS=	 '--prefix=/Users/whosemario/MyApplications/stackless-bin/'
